    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                //CreateManyCategorie(connection);
                //CreateCategorie(connection);
                //DeleteCategorie(connection);
        ...
        static void UpdateCategorie(SqlConnection connection)
        {
            ...
            Console.Write("{rows} registros atualizados");
        }
        static void DeleteCategorie(SqlConnection connection)
        {
        ...
        static void CreateManyCategorie(SqlConnection connection)
        {
            var category = new Category();
            category.Id = Guid.NewGuid();
            category.Title = "Amazon AWS";
        ...
        static void ExecuteProcedure(SqlConnection connection)
        {
            ...
            var pars = new { StudentId = "920a8b91-80bd-4955-a4a6-53b0a1aa7877" };
